    ...
    <div className="relative flex-1 overflow-none dark:bg-[#343541] bg-white">
      {!(apiKey || serverSideApiKeyIsSet) ? (
        <div className="flex flex-col justify-center mx-auto h-full w-[300px] sm:w-[500px] space-y-6">
          ...
          <div className="text-center text-gray-500 dark:text-gray-400">{t('Contact Manuel Porcincula For Api Key.')}</div>
        </div>
            ...
            {conversation.messages.length === 0 ? (
              <>
                <div className="flex flex-col mx-auto pt-12 space-y-10 w-[350px] sm:w-[600px]">
                  <div className="text-4xl font-semibold text-center text-gray-800 dark:text-gray-100">{models.length === 0 ? t("Loading...") : "Chatbot AI"}</div>
